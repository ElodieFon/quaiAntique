...
final class Version20230310161857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955F2A733EB FOREIGN KEY (heure_id) REFERENCES reservation_horaire (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955F2A733EB');
        ...
        $this->addSql('DROP TABLE reservation_horaire');
